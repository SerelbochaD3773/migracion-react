...
function Footer() {
  return (
    <div class="urban-gradient text-white py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2 text-gray-300">
              <li>
                <a href="#" class="hover:text-amber-400 transition-colors">Guía de tallas</a>
              </li>
              <li>
                <a href="#" class="hover:text-amber-400 transition-colors">Envíos</a>
              </li>
              <li>
                <a href="#" class="hover:text-amber-400 transition-colors">Devoluciones</a>
              </li>
              <li>
                <a href="#" class="hover:text-amber-400 transition-colors">FAQ</a>
              </li>
            </ul>
          </div>
          <div>
